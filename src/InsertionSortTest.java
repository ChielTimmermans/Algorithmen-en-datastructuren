...
class InsertionSortTest {
    ...
    /**
     * Deze test kijkt of de functie intertionSort goed functioneert voor een list met Integers.
     * Het sorteert de lijst en kijkst daarna of die gesorteerd is.
     * 
    ...
    /**
     * Deze test kijkt of de functie insertionSort goed functioneert voor een list met strings.
    ...
    void insertionSortString() {
        ...
        s = InsertionSort.insertionSort(s);
