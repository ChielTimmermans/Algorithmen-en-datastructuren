...
class BubbleSortTest {
    ...
    /**
     * Deze test kijkt of de functie bubbleSort goed functioneert voor een list met integers.
     * Het sorteerd de lijst en kijkt daarna of de lijst gesorteerd is.
     *
      */
    @Test
    void bubblesort() {
    ...
    /**
     * Deze test kijkt of de functie bubbleSort goed functioneert voor een list met string.
